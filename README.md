...
Ο Καναδάς είναι μια πολύ όμορφη χώρα με δριμύ χειμώνα. Το χειμώνα το χιόνι είναι συχνό και μπορούμε να θεωρήσουμε ότι τμήματα του οδικού δικτύου αποκλείονται λόγω χιονόπτωσης. Το επονομαζόμενο Πρόβλημα του Περιπλανόμενου Καναδού (Canadian Travelling Problem) είναι το εξής:
...
Ένας άλλος τρόπος να καταλάβετε το πρόβλημα είναι ως εξής. Ένας τυπικός Αθηναίος προσπαθεί να μετακινηθεί από ένα σημείο της Αθήνας σε ένα άλλο. Σχεδιάζει τη διαδρομή του, αλλά στην πορεία βρίσκεται αντιμέτωπος με δρόμους κλειστούς για διάφορους λόγους. Δεν ξέρει εκ των προτέρων ποιοι δρόμοι είναι κλειστοί. Όταν συνειδητοποιεί ότι ένας δρόμος είναι κλειστός, πρέπει να βρει εναλλακτική διαδρομή. Πλην όμως, μπορεί και στην εναλλακτική διαδρομή ένας δρόμος να είναι κλειστός. Η διαδικασία επαναλαμβάνεται μέχρι να φτάσει στον προορισμό του.
