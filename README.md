...
```
python ctp.py graph_file start_node destination_node [-r] [-b blocked_edges]
```
...
* Η παράμετρος `graph_file` δίνει το όνομα του αρχείου στο οποίο είναι αποθηκευμένος ο γράφος. Το αρχείο θα είναι της μορφής:
```
1 2 1
1 3 2
2 4 5
...
* Αν δίνεται η παράμετρος `-c`, το πρόγραμμα θα χρησιμοποιεί τον αλγόριθμο επανατοποθέτησης. Αλλιώς θα χρησιμοποιεί τον άπληστο αλγόριθμο. 

* Αν δίνεται η παράμετρος `-b blocked_edges` το πρόγραμμα θα διαβάζει τους κλειστούς συνδέσμους από το αρχείο `blocked_edges`. Το αρχείο `blocked_edges` θα είναι της μορφής:
```
1 2
1 3
2 4
...
* Αν δεν δίνεται η παράμετρος `-b blocked_edges`, τότε το πρόγραμμα θα εκτελεί απλώς τον αλγόριθμο του Dijkstra στο γράφο, χωρίς κλειστούς συνδέσμους.
...
Το πρόγραμμα θα εμφανίζει το μονοπάτι που θα ακολουθήσει ο ταξιδιώτης και από κάτω το κόστος του, με τη μορφή:
```
[1, 4, 2, 5, 8]
64
```
